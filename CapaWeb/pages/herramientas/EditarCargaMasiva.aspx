<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="EditarCargaMasiva.aspx.cs" Inherits="CapaWeb.pages.herramientas.EditarCargaMasiva" %>
                    ...
                    <asp:Table ID="Table1" Width="99%" runat="server" BorderColor="#e6e6fa" BorderWidth="1"
                        ...
                        <asp:TableRow>
                            <asp:TableCell HorizontalAlign="Right" VerticalAlign="Middle" CssClass="header" Width="5%">
                                ...
                                <asp:CheckBox ID="chkEnviados" runat="server" Text="&nbsp;Mostrar Documentos Enviados."
                                    AutoPostBack="True" OnCheckedChanged="chkEnviadoss_CheckedChanged" />&nbsp;&nbsp;
                                    ...
                                    <asp:Panel ID="pnlCollapsePlanificados" runat="server" CssClass="collapsePanelHeader"
                                        ...
                                        <div style="padding: 5px; cursor: pointer; vertical-align: middle;">
                                            <div style="float: left;" class="headerrow">
                                                Carga Masiva</div><div style="float: right; vertical-align: middle;">
                                    ...
                                    <asp:Panel ID="pnlDetallesPlanificado" runat="server" Width="100%">
                                        ...
                                        <asp:GridView ID="gvwEmpleado" Width="100%" runat="server" OnRowCommand="gvwEmpleado_RowCommand"
                                            ...
                                            <Columns>
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Editar">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnEditar" runat="server" CausesValidation="False" ImageUrl="~/images/buttons/edit.png"
                                                            Height="18px" Width="18px" CommandName="Editar" CommandArgument='<%# Bind("IdCarga") %>'>
                                                        </asp:ImageButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="IdCarga" HeaderText="Id Carga" ItemStyle-VerticalAlign="Middle"
                                                ...
                                                <asp:BoundField DataField="NrDocumento" HeaderText="NrDocumento" ItemStyle-VerticalAlign="Middle"
                                                    ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false">
                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="10%" Wrap="False" />
                                                </asp:BoundField>

                                                <asp:BoundField DataField="Concepto" HeaderText="Concepto" ItemStyle-VerticalAlign="Middle"
                                                    ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false">
                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="10%" Wrap="False" />
                                                </asp:BoundField>
...
<asp:RequiredFieldValidator ID="rfvTipo" runat="server" ErrorMessage="Seleccione Tipo "
                            ...
                            <asp:TableCell Text="Fecha de Recepcion :&nbsp;" CssClass="header"></asp:TableCell><asp:TableCell
                                ...
                                &nbsp;<asp:TextBox ID="txtFechaRecepcion" runat="server" Width="180px" ValidationGroup="Project"
                                    onblur="javascript:esFechaValida(this)"
...
</asp:TableCell><asp:TableCell Text="Fact. Reserva SAP : " CssClass="header">
                              </asp:TableCell><asp:TableCell CssClass="edit">
                               
                              &nbsp;<asp:TextBox ID="txtFactReserva" runat="server" Width="180px" TabIndex="9" />
