<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="ReporteDiasPorUsuario.aspx.cs" Inherits="CapaWeb.reportes.ReporteDiasPorUsuario" %>
            ...
            <table id="panTabs" cellspacing="2" cellpadding="5" width="100%" border="0" style="background-color: #0B52A0">
                <tr>
                    <td width="33%" style="vertical-align: middle;">
                        <asp:Label ID="lblTabGeneral" runat="server" Font-Bold="true" ForeColor="White" Font-Size="13px">Reporte de Días Por Usuario</asp:Label>
                    </td>
                </tr>
            </table>
        </asp:Panel>
                    ...
                    <table id="Report" width="100%" border="0">
                        <tr>
                            ...
                            <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                                <Report FileName="..\reportes\ReportDiasPorUsuario.rpt">
                                </Report>
