<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true"
    CodeBehind="ReporteFinanzasPagos.aspx.cs" Inherits="CapaWeb.reportes.ReporteFinanzasPagos" %>
            ...
            <ContentTemplate>
                <asp:Panel runat="server" ID="pnlBusqueda" DefaultButton="btnBuscar">
                    <table id="Table1" width="100%" border="0">
                        <tr>
                            <td width="10%">
                                <asp:Label ID ="lblIdMasivo" runat="server"  > ID Masivo  </asp:Label>
                            </td>
                            <td width="50%">
                        ...
                        <td>
                         ...
                         <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="True"
                            ...
                            <CR:CrystalReportSource ID="CrystalReportSource1" runat="server" 
                                Visible="False">
                                <Report FileName="~/reportes/ReportFinanzasPagos.rpt">
                                </Report>
                        ...
                        <tr>
                             <td>
                              <div>
                                        ...
                                        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="632px">
                                            </rsweb:ReportViewer>
