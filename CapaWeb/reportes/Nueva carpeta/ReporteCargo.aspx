<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true"
    CodeBehind="ReporteCargo.aspx.cs" Inherits="CapaWeb.reportes.ReporteCargo" %>
                        ...
                        <tr>
                            ...
                            <td width="20%">
                                <asp:Button runat="server" ID="btnImprimir" CssClass="button" Text="Imprimir" OnClick="btnImprimir_Click"
                                    Style="color: White; background: url(../../images/button_bg.png) center no-repeat;
                                    width: 100px; height: 26px; font: 11px Tahoma; visibility:hidden" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
                    ...
                    <table id="Report" width="100%" border="0">
                        <tr>
                            ...
                            <CR:CrystalReportSource ID="CrystalReportSource1" runat="server" 
                                Visible="False">
                                <Report FileName="~/reportes/ReportCargo.rpt">
                                </Report>
                        ...
                        <tr>
                            <td colspan="3">
                                ...
                                <%--<rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="1108px">
                                </rsweb:ReportViewer>--%>

                          <%--       <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="1108px" Visible="false">
                                    ...
                                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="487px" Width="1110px">
