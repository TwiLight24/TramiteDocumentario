...
namespace CapaWeb.reportes {
    ...
    public class ReportDiasPorUsuario : ReportClass {
        
        public ReportDiasPorUsuario() {
        }
        
        public override string ResourceName {
            get {
                return "ReportDiasPorUsuario.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "CapaWeb.reportes.ReportDiasPorUsuario.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedReportDiasPorUsuario : Component, ICachedReport {
        
        public CachedReportDiasPorUsuario() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ReportDiasPorUsuario rpt = new ReportDiasPorUsuario();
            rpt.Site = this.Site;
            return rpt;
        }
