...
namespace Intellisoft.Project.Web
{
    public partial class Principal : System.Web.UI.Page
    {
        ...
        {
            //Entidad.ParametroDetalle objDetalle = new Entidad.ParametroDetalle();
            //objDetalle = Intellisoft.Project.Control.ParametroDetalle.DatosFileUpload();
            //string completePath = objDetalle.UrlServidor + "pages/Password.aspx";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //lblUser.Text = (Session["UsuarioActual"] as Entidad.Usuario).NombreEmpleado;
        ...
        {
            Response.Redirect("~/pages/mantenimiento/Documento.aspx", false);
        }

        protected void imgbMant_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/OpMantenimiento.aspx", false);
        }
        ...
        /// </summary>
        //private Entidad.Usuario DatosUsuario()
        //{
        //    Entidad.Usuario objUsuario = new Entidad.Usuario();
        //    try
        //    {
        //        objUsuario = Session["UsuarioActual"] as Entidad.Usuario;
        //    }
        //    catch (Exception ex)
        //    {
