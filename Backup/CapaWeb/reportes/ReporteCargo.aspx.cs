...
namespace CapaWeb.reportes
{
    public partial class ReporteCargo : System.Web.UI.Page
    {
        ...
        private dsCargo GetData()
        {
            ...
            using (SqlConnection con = new SqlConnection("server=192.168.1.3;database=GMI_JCWEB_WTD;User ID=Desarrollo;Password=Gm1D35aApl1;Persist Security Info=True;"))
            {
        ...
        protected void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            //report.SetDatabaseLogon("Desarrollo", "Gm1D35aApl1", "192.168.1.3", "GMI_JCWEB_WTD");
