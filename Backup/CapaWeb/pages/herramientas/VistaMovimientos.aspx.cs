...
namespace CapaWeb.pages.herramientas
{
    public partial class VistaMovimientos : System.Web.UI.Page
    {
        ...
        //WebControls.DownloadFile ctlFile = null;
        ...
        protected void gvwHorasProyEmp_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            //{
            //    hdfIdActividad = (e.Row.FindControl("hdfIdActividad") as HiddenField);
            //    if (hdfIdActividad != null)
            //    {
            //        ctlFile = (e.Row.FindControl("ctlFile") as WebControls.DownloadFile);

            //        if (ctlFile != null)
            //        {
            //            ctlFile.IdActividad = Convert.ToInt32(hdfIdActividad.Value);
            //            ctlFile.IdEmpleado = Convert.ToInt32(this.hdfIdEmpleado.Value);
            //            ctlFile.IdPeriodo = Convert.ToInt32(this.hdfIdPeriodo.Value);
            //        }
            //    }
            //}
        }
